    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='customer.CustomerProfile')),
            ],
        ),
        migrations.CreateModel(
            name='ShopItem',
            fields=[
                ...
                ('count', models.IntegerField(default=0)),
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='item', to='customer.Order')),
            ],
        ),
        migrations.CreateModel(
            name='ProductSeries',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='customer.ProductSeries'),
        ),
        migrations.AddField(
            model_name='customerprofile',
            name='user',
